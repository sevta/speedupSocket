...
},{}],"Room.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  methods: {
    innerPopupClick: function innerPopupClick(e) {
      e.stopPropagation();
    }
  }
};
exports.default = _default;
        var $31053f = exports.default || module.exports;
      
      if (typeof $31053f === 'function') {
        $31053f = $31053f.options;
      }
    
        /* template */
        Object.assign($31053f, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c(
    ...
    {
      staticClass:
        "speedup-popup bg-black fixed pin-y pin-x flex items-center justify-center",
    ...
    [
      _c(
        ...
        {
          staticClass:
            "inner-speedup-popup w-auto bg-white p-4 flex items-center justify-center flex-col",
          on: { click: _vm.innerPopupClick }
        },
        [
          _c("h1", [_vm._v("speedup")]),
          _vm._v(" "),
          _c("div", { staticClass: "timer-room" }, [
            _vm._v(_vm._s(_vm.roomTimer))
          ]),
          _vm._v(" "),
          _c("p", { staticClass: "room-code" }, [_vm._v(_vm._s(_vm.roomCode))]),
          _vm._v(" "),
          _vm._l(_vm.users, function(user, index) {
            return _c(
              "div",
              { key: index, staticClass: "user-list-container flex flex-col" },
              [
                _vm._v(
                  _vm._s(user.username || "waiting") +
                    " " +
                    _vm._s(user.isReady ? "ready" : "")
                )
              ]
            )
          }),
          _vm._v(" "),
          _vm._l(_vm.users, function(user, index) {
            return _c("div", { key: "a" + index }, [
              user.isCreator && user.socketID === _vm.socketId
                ? _c(
                    "button",
                    {
                      staticClass: "btn-start bg-teal text-white py-2 px-4",
                      attrs: {
                        disabled:
                          user.isCreator &&
                          user.socketID === _vm.socketId &&
                          !_vm.isGameReady
                      },
                      on: { click: _vm.onCreatorStartGame }
                    },
                    [_vm._v("start game")]
                  )
                : _vm._e(),
              ...
              !user.isCreator && user.socketID === _vm.socketId
                ? _c(
                    "button",
                    {
                      staticClass: "btn-ready bg-red text-white py-2 px-4",
                      attrs: {
                        disabled:
                          !user.isCreator &&
                          user.socketID === _vm.socketId &&
...
render._withStripped = true
          ...
          return {
            ...
            _compiled: true,
            _scopeId: "data-v-31053f",
            functional: undefined
          };
        })());
      
},{}],"Game.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  computed: {
    avatarMove: function avatarMove() {
      return {
        color: "red",
        fontSize: "13px",
        transform: "translateX(".concat(this.x, "em) translateY(").concat(this.y, "em)"),
        transition: "all .6s ease"
      };
    }
  },
  watch: {
    typedText: function typedText(value) {
      this.checkByArray();
      this.userMovement();
    }
  },
  methods: {
    extractWords: function extractWords() {
      this.quotesSplit = _toConsumableArray(this.quotes);
      console.log(this.quotesSplit);
    },
    checkCursorSelection: function checkCursorSelection(e) {
      var position = e.target.selectionStart;
      this.cursorPosition = position;
      console.log(this.cursorPosition);
    },
    userMovement: function userMovement() {
      if (!this.isTypo) {
        if (this.step >= 0) {
    ...
    checkByArray: function checkByArray() {
      var correctIndex = -1;
      this.restText = this.quotesSplit.slice(this.typedText.length, this.quotes.length);
      ...
      for (var i = 0; i < this.typedText.length; i++) {
        console.log("index is ", i);

        if (this.step === this.quotesSplit.length - 1) {// this is winner
        }
        ...
        if (this.typedText[i] !== this.quotes[i]) {
          ...
          this.typoText = this.quotesSplit.slice(this.typoIndex, this.typedText.length);
          break;
        }
    ...
    checkWord: function checkWord() {// this.restText = this.quotes.slice(
...
exports.default = _default;
        var $0c02b8 = exports.default || module.exports;
      
      if (typeof $0c02b8 === 'function') {
        $0c02b8 = $0c02b8.options;
      }
    
        /* template */
        Object.assign($0c02b8, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    ...
    [
      _c("h1", [_vm._v("game is " + _vm._s(_vm.title))]),
      _vm._v(" "),
      _c("h1", [_vm._v(_vm._s(_vm.quotes))]),
      _vm._v(" "),
      _c("p", [_vm._v(_vm._s(_vm.typedText))]),
      _vm._v(" "),
      _c("h1", [_vm._v("step " + _vm._s(_vm.step))]),
      _vm._v(" "),
      _c("h3", [_vm._v("socket id " + _vm._s(_vm.socketId))]),
      _vm._v(" "),
      _vm.isTypo
        ? _c("p", { staticClass: "text-red font-bold my-2 text-center" }, [
            _vm._v("pleace correct the typo")
          ])
        : _vm._e(),
      _vm._v(" "),
      _vm._l(_vm.users, function(user, index) {
        return _c(
          ...
          {
            key: index,
            style: [user.socketID === _vm.socketId ? _vm.avatarMove : null]
          },
          [_vm._v(_vm._s(user.username || "waiting"))]
        )
      }),
      _vm._v(" "),
      _c(
        "div",
        { staticClass: "quote flex" },
        [
          _vm._l(_vm.correctText, function(correct, i) {
            return _vm.isCorrect
              ? _c(
                  "span",
                  {
                    key: "correct" + i,
                    staticClass: "correct text-white bg-teal font-bold p-1",
                    attrs: { unselectable: "on" }
                  },
                  [_vm._v(_vm._s(correct))]
                )
              : _vm._e()
          }),
          _vm._v(" "),
          _vm._l(_vm.typoText, function(typo, i) {
            return _vm.isTypo
              ? _c(
                  "div",
                  {
                    key: "typo" + i,
                    staticClass: "typo text-white font-bold bg-red p-1",
                    attrs: { unselectable: "on" }
                  },
                  [_vm._v(_vm._s(typo))]
                )
          ...
          _vm._v(" "),
          _vm._l(_vm.restText, function(rest, i) {
            return _c(
              "div",
              {
                key: "rest" + i,
                staticClass: "text-black p-1 bg-grey-lighter",
                attrs: { unselectable: "on" }
              },
              [_vm._v(_vm._s(rest))]
            )
...
},{"ms":"../../node_modules/ms/index.js"}],"C:/Users/sevta/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js":[function(require,module,exports) {
...
},{"./debug":"../../node_modules/socket.io-client/node_modules/debug/src/debug.js","process":"C:/Users/sevta/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js"}],"../../node_modules/socket.io-client/lib/url.js":[function(require,module,exports) {
...
},{"./debug":"../../node_modules/socket.io-client/node_modules/debug/src/debug.js","process":"C:/Users/sevta/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js"}],"../../node_modules/component-emitter/index.js":[function(require,module,exports) {
...
},{}],"C:/Users/sevta/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/base64-js/index.js":[function(require,module,exports) {
'use strict'
...
},{}],"C:/Users/sevta/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/ieee754/index.js":[function(require,module,exports) {
...
},{}],"C:/Users/sevta/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/buffer/index.js":[function(require,module,exports) {
...
},{"base64-js":"C:/Users/sevta/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/base64-js/index.js","ieee754":"C:/Users/sevta/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/ieee754/index.js","isarray":"../../node_modules/socket.io-parser/node_modules/isarray/index.js","buffer":"C:/Users/sevta/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/buffer/index.js"}],"../../node_modules/socket.io-parser/is-buffer.js":[function(require,module,exports) {
...
},{"buffer":"C:/Users/sevta/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/buffer/index.js"}],"../../node_modules/socket.io-parser/binary.js":[function(require,module,exports) {
/*global Blob,File*/
...
},{"isarray":"../../node_modules/socket.io-parser/node_modules/isarray/index.js","buffer":"C:/Users/sevta/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/buffer/index.js"}],"../../node_modules/arraybuffer.slice/index.js":[function(require,module,exports) {
/**
...
},{"./debug":"../../node_modules/socket.io-client/node_modules/debug/src/debug.js","process":"C:/Users/sevta/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js"}],"../../node_modules/engine.io-client/lib/transports/polling.js":[function(require,module,exports) {
/**
 * Module dependencies.
 */
...
},{"./polling":"../../node_modules/engine.io-client/lib/transports/polling.js","component-inherit":"../../node_modules/component-inherit/index.js"}],"C:/Users/sevta/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/_empty.js":[function(require,module,exports) {
...
},{"./url":"../../node_modules/socket.io-client/lib/url.js","socket.io-parser":"../../node_modules/socket.io-parser/index.js","./manager":"../../node_modules/socket.io-client/lib/manager.js","debug":"../../node_modules/socket.io-client/node_modules/debug/src/browser.js","./socket":"../../node_modules/socket.io-client/lib/socket.js"}],"App.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  data: function data() {
    ...
    return _ref = {
      ...
      isCreatorRoom: false,
      inRoom: false
    }, _defineProperty(_ref, "inGame", false), _defineProperty(_ref, "roomFound", false), _defineProperty(_ref, "isUserReady", false), _defineProperty(_ref, "isGameReady", false), _defineProperty(_ref, "debug", false), _defineProperty(_ref, "socket", null), _defineProperty(_ref, "usersInRoom", _toConsumableArray(Array(4).fill("waiting"))), _ref;
  },
  mounted: function mounted() {
    var _this = this;

    console.log("mounted");
    fetch("https://uinames.com/api/?amount=25").then(function (res) {
      return res.json();
    }).then(function (data) {
      var random = function random(val) {
        return Math.floor(Math.random() * data.length);
      };

      _this.username = data[random(data)].name;
      console.log("username", _this.username);
      _this.socket = _socket.default.connect("http://localhost:4200");
  ...
  methods: {
    handleSocket: function handleSocket() {
      var _this2 = this;

      // first connect
      console.log("first connect");
      this.socket.on("first connect", function (_ref2) {
        var socketID = _ref2.socketID;
        console.log(socketID);
        _this2.socketID = socketID;
        console.log("first connect", _this2.socketID);

        _this2.socket.emit("reply connect", {
          username: _this2.username,
          socketID: _this2.socketID
        });
      }); // start timer room

      this.socket.on("start room timer", function (_ref3) {
        var roomTimer = _ref3.roomTimer;
        console.log("room timer", roomTimer);
        _this2.timerRoom = roomTimer;
      }); // timer done

      this.socket.on("room timer done", function () {
        _this2.popupRoom = false;

        _this2.socket.emit("reset user in timer done", {
          socketID: _this2.socketID
        });
      });
      this.socket.on("creator stop timer room", function () {
        console.log("im creator and room is done");
        _this2.isCreatorRoom = false;

        _this2.socket.emit("reply creator stop timer room", {
          socketID: _this2.socketID,
          roomID: _this2.roomID
        });
      });
      this.socket.on("room found", function (_ref4) {
        var roomID = _ref4.roomID;
        console.log("room found", roomID);
        _this2.roomFound = true;
        _this2.roomID = roomID;
        _this2.popupRoom = true;
      });
      this.socket.on("reply creator leave room", function () {
        console.log("socket leave room");
        _this2.roomID = null;
        _this2.popupRoom = false;
      });
      this.socket.on("update users in room", function (_ref5) {
        var users = _ref5.users;
        console.log("users", users);
        _this2.usersInRoom = _toConsumableArray(users).concat(_toConsumableArray(Array(_this2.usersInRoom.length - users.length).fill("waiting...")));
      });
      this.socket.on("creator disconnect", function () {
        console.log("creator disconnect");
        _this2.roomID = null;
        _this2.popupRoom = false;
      });
      this.socket.on("game is ready", function () {
        console.log("game ready");
        _this2.isGameReady = true;
      });
      this.socket.on("start game", function () {
        _this2.startGame();
      });
    },
    ...
    onUserReady: function onUserReady() {
    ...
    onCreatorStartGame: function onCreatorStartGame() {
...
exports.default = _default;
        var $eab98a = exports.default || module.exports;
      
      if (typeof $eab98a === 'function') {
        $eab98a = $eab98a.options;
      }
    
        /* template */
        Object.assign($eab98a, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    ...
    [
      _vm.inGame
        ? _c("game", {
            attrs: {
              users: _vm.usersInRoom,
              "socket-id": _vm.socketID,
              socket: _vm.socket
            }
          })
        : _vm._e(),
      ...
      _vm.popupRoom
        ? _c("popup-room", {
            attrs: {
              onbackdropclick: _vm.backdropClick,
              "room-timer": _vm.timerRoom,
              "room-code": _vm.roomID,
              users: _vm.usersInRoom,
              "socket-id": _vm.socketID,
              "on-user-ready": _vm.onUserReady,
              "is-game-ready": _vm.isGameReady,
              "on-creator-start-game": _vm.onCreatorStartGame
            }
          })
        : _vm._e(),
      _vm._v(" "),
      !_vm.inGame
        ? _c("div", { staticClass: "loby" }, [
            _c("h1", [_vm._v(_vm._s(_vm.username))]),
            _vm._v(" "),
            _c("p", [_vm._v("socket id " + _vm._s(_vm.socketID))]),
            _vm._v(" "),
            _vm.toggleJoin
              ? _c(
                  "form",
                  {
                    staticClass: "speedup-inputroomcode-form",
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.searchRoomCode,
                          expression: "searchRoomCode"
                        }
                      ],
                      staticClass: "input-room-code",
                      attrs: { type: "text", placeholder: "input room code" },
                      domProps: { value: _vm.searchRoomCode },
                      on: {
                        input: [
                          function($event) {
                            if ($event.target.composing) {
                            ...
                            _vm.searchRoomCode = $event.target.value
                          },
                          _vm.onInput
                        ]
                      }
            ...
            _c("div", { staticClass: "button-container" }, [
              _c(
                "button",
                {
                  staticClass: "bg-teal text-white p-2 btn-create",
              ...
              _c(
                "button",
                {
                  staticClass: "bg-teal text-white p-2 btn-join",
...
render._withStripped = true
          ...
          return {
            ...
            staticRenderFns: staticRenderFns,
            _compiled: true,
            _scopeId: "data-v-eab98a",
            functional: undefined
          };
        })());
      
},{"./Room":"Room.vue","./Game":"Game.vue","socket.io-client":"../../node_modules/socket.io-client/lib/index.js"}],"main.js":[function(require,module,exports) {
"use strict";
...
},{"vue":"../../node_modules/vue/dist/vue.runtime.esm.js","./App":"App.vue"}]},{},["main.js"], null)
